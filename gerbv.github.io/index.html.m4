    ...
    <div id="main_content_wrap" class="outer">
      <section id="main_content" class="inner">
       ...
       <table style="width: 100%">
         ...
         <tr>
           <td style="vertical-align: middle"><img src="assets/Fedora_icon_(2021).svg" alt="Fedora 34" title="Fedora 34" style="height: 100px; box-shadow: none; border: none" /></td>
           <td style="vertical-align: middle">include(ci/Fedora 34.RELEASE_DATE)</td>
           <td style="vertical-align: middle"><code><a href="https://github.com/gerbv/gerbv/tree/include(ci/Fedora 34.RELEASE_COMMIT)">include(ci/Fedora 34.RELEASE_COMMIT_SHORT)</a></code></td>
           <td style="vertical-align: middle"><a class="tar_download_link" href="ci/include(ci/Fedora 34.RELEASE_FILENAME)">Download Fedora 34 binaries</a></td>
         </tr>
         <tr>
