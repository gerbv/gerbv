...
#define ACCEL_FILE_SAVE_LAYER_AS_KEY		GDK_KEY_A
...
#define ACCEL_VIEW_ALL_SELECTION_KEY		GDK_KEY_l
...
#define ACCEL_VIEW_CROSS_ON_DRILL_HOLES_KEY	GDK_KEY_x
...
#define ACCEL_LAYER_DELETE_KEY			GDK_KEY_Delete
